"use strict";
var fs = require('fs');
var getCompiledPath = require('/Volumes/Aaditya\'s SSD/Development/boardlyX-backend/node_modules/ts-node-dev/lib/get-compiled-path').getCompiledPath;
var sep = require('path').sep;
var join = require('path').join;
var extname = require('path').extname;
var execSync = require('child_process').execSync;
var Module = require('module');
var compilationId = "11724635324026389";
var timeThreshold = 0;
var allowJs = true;
var compiledDir = "/Volumes/Aaditya's SSD/Development/boardlyX-backend/.tmp/.ts-nodegFiaQs/compiled";
var preferTs = false;
var ignore = [/node_modules/];
var readyFile = "/Volumes/Aaditya's SSD/Development/boardlyX-backend/.tmp/ts-node-dev-ready-11724635324026389";
var execCheck = false;
var exitChild = false;
var sourceMapSupportPath = "/Volumes/Aaditya\\'s SSD/Development/boardlyX-backend/node_modules/source-map-support/source-map-support.js";
var libPath = "/Volumes/Aaditya's SSD/Development/boardlyX-backend/node_modules/ts-node-dev/lib";
var checkFileScript = join("/Volumes/Aaditya\'s SSD/Development/boardlyX-backend/node_modules/ts-node-dev/lib", 'check-file-exists.js');
